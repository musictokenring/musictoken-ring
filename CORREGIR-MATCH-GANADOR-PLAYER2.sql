...
DECLARE
    ...
    user_ganador UUID := '0940db31-9a51-403b-bfcc-cc66c383eb91'; -- Player 2
    user_perdedor UUID := '978e9e29-11b0-405d-bf68-b20622016aad'; -- Player 1
...
BEGIN
    ...
    RAISE NOTICE '✅ Match finalizado con ganador Player 2';
