-- ============================================================================
-- Query para verificar usuarios existentes y su compatibilidad
-- Ejecuta esto en Supabase SQL Editor para verificar que todo está bien
-- ============================================================================

-- 1. Verificar usuarios existentes y sus wallets (SIN email - columna no existe)
SELECT 
    u.id,
    u.wallet_address,
