...
-- Para identificar discrepancias en las estadísticas
-- ==========================================

-- Player 1 (HOMEFIX APP)
SELECT 
...
-- ==========================================
-- Ver resumen de estadísticas actuales vs esperadas
-- ==========================================
SELECT 
    'Player 1 (HOMEFIX APP)' AS jugador,
    u.total_matches AS partidas_actuales,
    u.total_wins AS victorias_actuales,
    u.total_losses AS derrotas_actuales,
    u.total_credits_won AS creditos_ganados_actuales,
    -- Contar matches reales finalizados
