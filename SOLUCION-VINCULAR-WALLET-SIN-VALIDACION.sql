-- ============================================
-- SOLUCIÓN: Vincular wallet al usuario (SIN validación de placeholder)
...
-- 
-- Para encontrar la wallet:
-- 1. Ejecuta BUSCAR-WALLET-DEL-USUARIO.sql primero
-- 2. O pregunta al usuario qué wallet usó (Trust Wallet)
-- 3. O revisa los logs del backend cuando se procesó el depósito
-- ============================================
...
BEGIN
    -- Validar formato de wallet (pero NO validar placeholder para evitar error)
    IF v_wallet_address = 'WALLET_ADDRESS_AQUI' THEN
        RAISE EXCEPTION 'Debes reemplazar WALLET_ADDRESS_AQUI con la wallet address real del usuario. Ejecuta BUSCAR-WALLET-DEL-USUARIO.sql primero para encontrarla.';
    END IF;
